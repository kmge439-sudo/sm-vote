...
// ==========================================
// [보안 데이터] 849명 전교생 고유 인증 코드 (형식 오류 수정 완료)
// ==========================================
            ...
            {[2, 3, 4, 5].includes(step) && (
              <div className="animate-in slide-in-from-right-8 duration-500">
                <div className="flex justify-between items-end mb-8">
                  ...
                  <span className="text-xs font-black text-slate-400 tracking-widest uppercase text-slate-400 font-sans">Step {step-1} / 4</span>
                </div>
                ...
                <div className="p-8 space-y-8 animate-in fade-in duration-500 text-slate-900 font-sans">
                  ...
                  {adminTab === 'stats' ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="bg-white border rounded-2xl overflow-hidden max-h-[300px] overflow-y-auto shadow-inner text-slate-900 font-sans text-slate-900">
                            ...
                            {filteredParticipationList.map((s, idx) => {
                              ...
                              return (
                                <tr key={`${s.key}-${idx}`} className="hover:bg-slate-50 transition-colors">
                                  <td className="p-3 font-black text-slate-900 text-slate-900">{s.grade}-{s.class}-{s.number} {s.name}</td>
                                  <td className="p-3 text-center whitespace-nowrap text-slate-900">
                                  ...
                                  <td className="p-3 text-center text-[9px] font-bold text-slate-500 font-sans whitespace-nowrap text-slate-900">
